...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      'lockout (extension profiles only): detaches all tabs and disconnects the relay so the user gets their browser back. When you finish a task using profile=”chrome-relay”, offer to lockout so the user\'s tabs are no longer under agent control.',
